...
export const metadata: Metadata = {
  ...
  description:
    "Need help with your order? Have questions about sizing or returns? Contact our customer service team for assistance with your MODERNO clothing purchase.",
};

export default function ContactPage() {
  return (
    <div className="my-16 py-16 px-4 sm:px-6 md:px-8 lg:px-12 max-w-7xl mx-auto">
      <h1 className="text-3xl md:text-4xl font-light mb-4 text-center">
        CONTACT US
      </h1>
      <p className="text-neutral-600 text-center max-w-2xl mx-auto mb-8 md:mb-12">
        We're here to help with any questions about your order, our products, or
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
        <div className="bg-neutral-50 p-6 flex flex-col items-center text-center">
          ...
          <Link
            href="#contact-form"
            className="text-sm underline underline-offset-4 mt-auto"
          >
            Send a Message
          </Link>
        </div>
        ...
        <div className="bg-neutral-50 p-6 flex flex-col items-center text-center">
          ...
          <p className="text-neutral-600 text-sm mb-3">
            Help with existing orders or payments
          </p>
          <Link
            href="#contact-form"
            className="text-sm underline underline-offset-4 mt-auto"
        ...
        <div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-neutral-600">
                  <a
                    href="mailto:support@MODERNO.com"
                ...
                <p className="text-neutral-600">
                  <a
                    href="mailto:orders@MODERNO.com"
                    className="hover:underline"
                  >
                    orders@MODERNO.com
                  </a>{" "}
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-neutral-600 text-sm">
                  Available Sunday - Friday, 10am - 6pm NPT
                </p>
              </div>
            </div>
          ...
          <div id="shipping-info" className="mb-10">
            ...
            <div className="bg-neutral-50 p-6">
              ...
              <p className="text-neutral-600">
                ...
                confirmation. Tracking information will be provided via email
          ...
          <div id="returns-policy">
            ...
            <div className="bg-neutral-50 p-6">
              ...
              <p className="text-neutral-600 mb-3">
                Exchanges are available for size issues. Please contact our
                customer service team to arrange an exchange.
              </p>
              <p className="text-neutral-600">
      ...
      <div className="mt-16 text-center">
        ...
        <p className="text-neutral-600 mt-6 max-w-xl mx-auto">
          Follow us on social media for styling tips, behind-the-scenes content,
          and to be the first to know about new arrivals and special promotions.
        </p>
      </div>
    </div>
  );
